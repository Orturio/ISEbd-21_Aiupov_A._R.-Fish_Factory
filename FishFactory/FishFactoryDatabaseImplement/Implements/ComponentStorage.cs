...
namespace FishFactoryDatabaseImplement.Implements
{
    public class ComponentStorage : IComponentStorage
    {
        public List<ComponentViewModel> GetFullList()
        {
            ...
            {
                return context.Components.Select(rec => new ComponentViewModel{Id = rec.Id,ComponentName = rec.ComponentName}).ToList();
            }
        }
...
{Id = rec.Id,ComponentName = rec.ComponentName}).ToList();
            }
        }
